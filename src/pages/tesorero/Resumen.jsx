...
import {
  ...
  CalendarDays, Users, ArrowRight, Loader2, AlertCircle,
} from "lucide-react";
    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
        <StatCardResumen
          ...
          icon={Wallet} iconBg="bg-amber-100" iconColor="text-amber-600"
        ...
        <StatCardResumen
          ...
          icon={TrendingDown} iconBg="bg-red-100" iconColor="text-red-500"
        />
        <StatCardResumen
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        >
          ...
          <div>
            <p className="text-2xl font-black text-stone-800">{resumen?.total_padres ?? 0}</p>
            <p className="text-xs text-stone-400 font-medium">Padres registrados</p>
          </div>
        </div>
        ...
        >
          ...
          <div>
            <p className="text-2xl font-black text-stone-800">{resumen?.eventos_activos ?? 0}</p>
            <p className="text-xs text-stone-400 font-medium">Eventos activos</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-stone-100">
        <div className="flex items-center justify-between px-5 py-4 border-b border-stone-50">
          <p className="text-sm font-black text-stone-700">Últimos movimientos</p>
          <button
